...
![图1 A1各领域的候选冲突率](../../figures/fig1_domain_conflict.png)
...
![图2 固定A1拟合参照下的阈值敏感性](../../figures/fig2_threshold_sensitivity.png)

![图3 保守程度对候选均分的影响](../../figures/fig3_compensation_sensitivity.png)
